...
//   // in the above code we have used props but here we are using directly propNames we are getting from category component from App.js
//   return (
//     <>
//       <div className="col">
//         <div className="category text-center">
...
// if we want to make the property or variable to not to have any blank we have to use required keyword as shown above in line 62 (img: PropTypes.string.isRequired,). By default if we do not give the img value in the above code then also it works fine.
